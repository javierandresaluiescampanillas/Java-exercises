...
public class Ejercicio16 {
  ...
  public static void main(String[] args) {
    ...
    System.out.print("2. Han aumentado sus gastos de vestuario.\n(v)erdadero o (f)also: ");
    respuesta = System.console().readLine();
    if ( respuesta.equals("v") ) {
      puntos += 3;
    }
    ...
    if ( puntos <= 10 ) {
      System.out.print("Es fiel.");
    }
    
    if ( (puntos > 11 ) && (puntos <= 22) ) {
      System.out.print("Gánatela más por si acaso.");    
    }
    
    if ( puntos >= 22 ) {
      System.out.print("Tu pareja te la está liando casi seguro.");
    }
  }
}
